class Edit extends React.Component {
    ...
    render () {
        ...
        var elem = (
            <div>
                <form action="/modSubFam" method="post" encType="multipart/form-data">
                    <div>
                ...
                <form action="/elimSubFam" method="post">
                    <input type="text" name="id" value={this.props.data._id} style={{"display": "none"}} readOnly/>
                    <input type="submit" value="Eliminar"/>
                    <span>Si elimina se eliminaran todos platos pertenecientes.</span>
                </form>
            </div>
        );
        return elem;
