    ...
    _createClass(Edit, [{
        ...
        value: function render() {
            ...
            var elem = React.createElement(
                ...
                React.createElement(
                    "form",
                    { action: "/modFam", method: "post", encType: "multipart/form-data" },
                    React.createElement(
                        "div",
                        null,
                        React.createElement(
                ...
                React.createElement(
                    "form",
                    { action: "/elimFam", method: "post" },
                    React.createElement("input", { type: "text", name: "id", value: this.props.data._id, style: { "display": "none" }, readOnly: true }),
                    React.createElement("input", { type: "submit", value: "Eliminar" }),
                    React.createElement(
                        "span",
                        null,
                        "Si elimina se eliminaran todas las subfamilias y los platos pertenecientes."
                    )
                )
            );
            return elem;
